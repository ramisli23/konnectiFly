...
class _BuyesimdetailsState extends State<Buyesimdetails> {
  ...
  PackagePricing? _selectedPackage; // ✅ PACKAGE SÉLECTIONNÉ
  ...
  Future<void> _loadData() async {
    try {
      ...
      setState(() {
        _selectedPackage = null; // reset sélection
  ...
  void initState() {
    ...
    _packagesFuture = context.read<PackagesProvider>().fetchPackagesByCountry(
      countryId: widget.countryId,
      type: "DATA-ONLY",
      mode: "limited",
    );
        ...
        builder: (context, snapshot) {
          ...
          return CustomScrollView(
            slivers: [
              ...
              // ✅ Affiche le prix du package sélectionné
              SliverToBoxAdapter(
              ...
              ///       GRID DES OFFRES AVEC SÉLECTION
    ...
    return SliverPadding(
      ...
      sliver: SliverGrid(
        ...
        delegate: SliverChildBuilderDelegate((context, index) {
          ...
          final selected = _selectedPackage?.id == p.id;
  ...
  Widget _actionButtons() {
    ...
    if (p == null) {
      return const Padding(
        ...
        child: Center(child: Text("Veuillez sélectionner un package")),
      );
    }
          ...
          Expanded(
            child: ElevatedButton(
              onPressed: () async {
                ...
                if (invoice == null || invoice["paymentUrl"] == null) {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => PaymentURLLauncher(url: paymentUrl),
                  ),
                );
              },
  ...
  Widget _loader() =>
      Center(child: Lottie.asset("assets/lottie/progess.json", width: 120));

  Widget _errorReloadButton() => Center(
      ...
      sliver: SliverGrid(
        ...
        delegate: SliverChildBuilderDelegate((context, index) {
          ...
          return GestureDetector(
            onTap: () {
              setState(() {
                _selectedPackage = p; // ✅ SELECT PACKAGE
              });
            },
             child: Offrecards(
              ...
              onPressed: () async {
                ...
                try {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) => PaymentURLLauncher(url: paymentUrl),
                      //PaymentWebViewe(url: paymentUrl, userId: ''),
                    ),
                  );
                } catch (e) {
