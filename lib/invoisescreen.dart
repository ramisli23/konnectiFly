      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              const Text(
                "NOTE: use Account or Contact UUID  to create Invoice",
              ...
              TextField(
                ...
                decoration: const InputDecoration(labelText: "Contact (UUID)"),
              ),
              TextField(
                controller: accountController,
                decoration: const InputDecoration(labelText: "Account (UUID)"),
              ),
              TextField(
