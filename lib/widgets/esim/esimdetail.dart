...
class Esimdetail extends StatelessWidget {
  final List<DataOnly> esims;
  const Esimdetail({super.key, required this.esims});
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          /*  final String name = esim.name ?? "Unnamed SIM";
          final String status = esim.status ?? "Unknown";
          final String validity = esim.validity ?? "N/A";
